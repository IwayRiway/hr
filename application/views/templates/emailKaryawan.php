                          ...
                          <tbody>
                            ...
                            <tr>
                              <td align="left" style="font-size:0px;padding:0px;padding-bottom:20px;word-break:break-word;">
                                <div style="font-family:Poppins, Lato, Helvetica, Arial, sans-serif;font-size:16px;font-weight:100;line-height:1.5;text-align:left;color:#000000;"><strong>Keterangan <span>: <?=$keterangan?></span></strong></div>
                              </td>
                            </tr>
                          </tbody>
                        </table>
                          ...
                          <tbody>
                            <tr>
                              <td align="left" style="font-size:0px;padding:0px;padding-top:20px;word-break:break-word;">
                                <div style="font-family:Poppins, Lato, Helvetica, Arial, sans-serif;font-size:16px;line-height:1.5;text-align:left;color:#000000;">Anda juga dapat mengkonfirmasi pengajuan cuti tersebut pada aplikasi <a href="hr.mywayout.my.id/auth">hr.mywayout.my.id</a></div>
                              </td>
                            </tr>
                          </tbody>
                        </table>
